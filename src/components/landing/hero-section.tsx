    ...
    <section id="inicio" className="relative pt-20 bg-white overflow-hidden">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-center bg-[#F8F7FF] rounded-3xl p-4 lg:p-6">
          ...
          <div className="lg:col-span-1 text-center lg:text-left space-y-2 self-center animate-in fade-in slide-in-from-bottom-4 duration-1000">
          ...
          <div className="lg:col-span-2 relative w-full flex flex-col items-center lg:items-end animate-in fade-in zoom-in-95 duration-1000 delay-300">

...
export function StepsSection() {
  ...
  return (
    <section id="como-funciona" className="py-16 bg-[#F8FAFC] relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 relative">
            ...
            <div className="hidden md:block absolute top-10 left-0 w-full h-0.5 bg-gradient-to-r from-gray-200 via-gray-200 to-transparent -z-10"></div>
